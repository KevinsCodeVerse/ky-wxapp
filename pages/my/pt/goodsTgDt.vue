<template>
  <view>
    <view style="width: 100vw;">
      <image src="/static/my/pt_background.png" style="width: 100vw;z-index: -1;"></image>
    </view>
    <view style="margin: 0 36rpx;top: 20rpx;position: absolute;">
      ...
      <view style="position: relative; width: 686rpx; height: 240rpx; margin: 38rpx 0 24rpx 0;">
        <!-- 使用 image 标签作为背景 -->
        <image src="/static/my/pt_amountBck.png" mode="aspectFill"
               style="position: absolute; width: 686rpx; height: 240rpx; top: 0; left: 0;border-radius: 12px;"></image>
        ...
        <view style="padding: 32rpx; color: #fff; position: relative;">
          <view style="display: flex; justify-content: space-between; font-size: 28rpx;">
            <view>余额</view>
            <view style="display: flex; align-items: center;" @click="openPage('pages/my/pt/flow/flow')">
              明细
          ...
          <view style="display: flex; justify-content: space-between; font-size: 28rpx; margin-top: 15rpx;">
            ...
            <view style="width: 104rpx;height: 48rpx;border-radius: 24rpx;background: #ffffff00;border: 2rpx solid #fff;">
              <view @click="openPage('pages/my/pt/withdrawal/withdrawal?balance='+userInfo.adAmount,2)"
			  style="font-size: 28rpx;text-align: center;color: #fff;line-height: 48rpx;">提现</view>
            </view>
          </view>
        </view>
      </view>
      ...
      <!-- 我的收益 -->
      <view
          style="width: 686rpx;height: 88rpx;border-radius: 24rpx 24rpx 0 0;background: linear-gradient(90.00deg, #d6ddff 0%, #fff 100%);padding: 28rpx 20rpx;">
        <view style="display: flex;align-items: center;gap: 12rpx">
          <u-image width="32rpx" height="32rpx" src="/static/my/pt_shouyi.png" v-if="unit == 2"></u-image>
      ...
      <view
        ...
        <view style="font-size: 24rpx;text-align: center;color: #999;">
          邀请商户入驻最高奖励 {{from.merchantIviteMoney}}元
        </view>
        <view style="display: flex;justify-content: space-between;">
          <view
              style="margin: auto;width: 280rpx;height: 80rpx;border-radius: 40rpx;background: linear-gradient(90.00deg, #002FA7 0%, #002FA7 100%);"
          ...
          <view style="display: flex;flex-direction: column;align-items: center;">
            ...
            <view style="display: flex;justify-content: flex-start;flex-direction: column;margin-bottom: 20rpx;">
              ...
              <view style="font-size: 24rpx;line-height: 36rpx;text-align: left;color: #999;margin-top: 5rpx;">
                条件:无需业绩条件<br/>
                每直接推荐商户入驻奖励{{ Math.floor(from.ptZ * 10000) / 100 }}%{{unit==1?'积分':'元'}}，间接推荐下单奖励{{ Math.floor(from.ptJ * 10000) / 100 }}%{{unit==1?'积分':'元'}}
              </view>
            </view>
            <view style="display: flex;justify-content: flex-start;flex-direction: column;margin-bottom: 20rpx;">
              ...
              <view style="font-size: 24rpx;line-height: 36rpx;text-align: left;color: #999;margin-top: 5rpx;">
                ...
                每直接推荐商户入驻奖励{{ Math.floor(from.hjZ * 10000) / 100 }}%{{unit==1?'积分':'元'}}，间接推荐下单奖励{{ Math.floor(from.hjJ * 10000) / 100 }}%{{unit==1?'积分':'元'}}
              </view>
            </view>
            <view style="display: flex;justify-content: flex-start;flex-direction: column;margin-bottom: 20rpx;">
              ...
              <view style="font-size: 24rpx;line-height: 36rpx;text-align: left;color: #999;margin-top: 5rpx;">
                ...
                每直接推荐商户入驻奖励{{ Math.floor(from.hhrZ * 10000) / 100 }}%{{unit==1?'积分':'元'}}，间接推荐下单奖励{{ Math.floor(from.hhrJ * 10000) / 100 }}%{{unit==1?'积分':'元'}}
              </view>
            </view>
            <view style="display: flex;justify-content: flex-start;flex-direction: column;margin-bottom: 20rpx;">
              ...
              <view style="font-size: 24rpx;line-height: 36rpx;text-align: left;color: #999;margin-top: 5rpx;">
                ...
                每直接推荐商户入驻奖励{{ Math.floor(from.zzHhrZ * 10000) / 100 }}%{{unit==1?'积分':'元'}}，间接推荐下单奖励{{ Math.floor(from.zzHhrJ * 10000) / 100 }}%{{unit==1?'积分':'元'}}
              </view>
            </view>

            <view
                style="width: 510rpx;height: 92rpx;border-radius: 46rpx;background: linear-gradient(90.00deg, #002FA7 0%, #002FA7 100%);margin-top: 35rpx;">
              <view
    ...
    <view
      ...
      <view style="display: flex;justify-content: space-between;">
        <view @click="openPage('/pages/my/pt/goodsTgDt',1)"
        ...
        <view @click="openPage('/pages/my/pt/team',1)"
              style="display: flex;flex-direction: column;align-items: center;width: 180rpx;height: 100rpx;justify-content: center;">
        ...
        <view @click="openPage('/pages/my/pt/fyJl',1)"
              style="display: flex;flex-direction: column;align-items: center;width: 180rpx;height: 100rpx;justify-content: center;">
