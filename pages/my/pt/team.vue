          ...
          <view style="display: flex;align-items: center;">
            ...
            <view
              ...
              <view style="width: 144rpx;height: 52rpx;border-radius: 26rpx;background: #fff2d6;">
                <view
				@click="openPage('/pages/my/pt/fyJl?usId='+item.usId+'&usNick='+item.nick,2)"
              ...
              <view style="display: flex;align-items: flex-end;">
                ...
                <view @click="openPage('/pages/my/pt/team?usId='+item.usId+'&usNick='+item.nick,2)">
...
export default {
  ...
  methods: {
    ...
    getList(){
      ...
      this.$request.post({
        url: 'user/userRoyalFlow/tenantTeam',
		params: this.params,
        success: (result) => {
    ...
    teamCount(id) {
      this.$request.post({
        url: 'user/userRoyalFlow/tenantTeamCount',
		params: {
			id: this.params.id
		},
        success: (result) => {
